...
func (b *Backend) listv2(ctx context.Context, t backend.FileType, resp *http.Response, fn func(backend.FileInfo) error) error {
...
func (b *Backend) removeKeys(ctx context.Context, t backend.FileType) error {
	return b.List(ctx, t, func(fi backend.FileInfo) error {
		return b.Remove(ctx, backend.Handle{Type: t, Name: fi.Name})
	})
}
...
func (b *Backend) Delete(ctx context.Context) error {
	...
	err := b.Remove(ctx, backend.Handle{Type: backend.ConfigFile})
