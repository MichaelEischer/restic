...
// Backend wraps a backend.Backend and adds a cache.
type Backend struct {
	backend.Backend
	*Cache
...
func (b *Backend) loadFromCache(ctx context.Context, h backend.Handle, length int, offset int64, consumer func(rd io.Reader) error) (bool, error) {
