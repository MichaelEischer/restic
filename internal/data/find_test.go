...
func TestFindUsedBlobs(t *testing.T) {
	...
	for i := 0; i < findTestSnapshots; i++ {
		sn := data.TestCreateSnapshot(t, repo, findTestTime.Add(time.Duration(i)*time.Second), findTestDepth, 0)
...
func TestFindUsedBlobsSkipsSeenBlobs(t *testing.T) {
	...
	snapshot := data.TestCreateSnapshot(t, repo, findTestTime, findTestDepth, 0)
...
func BenchmarkFindUsedBlobs(b *testing.B) {
	...
	sn := data.TestCreateSnapshot(b, repo, findTestTime, findTestDepth, 0)
