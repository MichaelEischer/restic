...
func LoadTree(ctx context.Context, r BlobLoader, id restic.ID) (*Tree, error) {
...
type BlobSaver interface {
	SaveBlob(context.Context, restic.BlobType, []byte, restic.ID, bool) (restic.ID, bool, int, error)
}
...
// contain the ID.
func SaveTree(ctx context.Context, r BlobSaver, t *Tree) (restic.ID, error) {
