...
func (node *Node) CreateAt(ctx context.Context, path string, repo restic.Repository) error {
...
func (node Node) createFileAt(ctx context.Context, path string, repo restic.Repository) error {
...
func (node Node) writeNodeContent(ctx context.Context, repo restic.Repository, f *os.File) error {
	var buf []byte
