...
// item.
func FilterLastestSnapshots(list data.Snapshots, limit int) data.Snapshots {
...
func PrintSnapshots(stdout io.Writer, list data.Snapshots, reasons []data.KeepReason, compact bool) {
